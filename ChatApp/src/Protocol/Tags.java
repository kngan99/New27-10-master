...
public class Tags {
    ...
    public static String CLIENT_LIST_REQ = "<LIST_CLIENT_REQ/>";//34
    
    public static String SERVER_ONLINE = "ALIVE";
	public static String SERVER_OFFLINE = "OOPS >>>WILL BE KILLED<<< ";
	
	public static String SIGNIN_SUCCESSFUL = "Sign in successful! You can now login with your account!";
	public static String DUPLICATE_USER = "Your account has already connected to the server!";
	public static String EXISTS_DB = "Please choose another username!";
	public static String WRONG_PASSWORD = "Please check your username/password!";
	public static String INVALID_REQUEST = "Request Error";
	public static String NO_FRIEND = "You have no friend, poor you!";
	
	public static int IN_VALID = -1;
	public static int MAX_MSG_SIZE = 1024;
	public static int show(JFrame frame, String string, boolean b) {
		// TODO Auto-generated method stub
		if (b)
			return JOptionPane.showConfirmDialog(frame, string, null, JOptionPane.YES_NO_OPTION);
